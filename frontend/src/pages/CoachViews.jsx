        ...
        <div className="view-container fade-in">
            ...
            <div className="glass-panel" style={{ padding: '30px', maxWidth: '600px', margin: '0 auto', border: '1px solid var(--accent-primary)' }}>
                ...
                <div className="form-group">
                    ...
                    <input type="number" step="0.5" className="glass-input" value={form.training_hours} onChange={e => setForm({...form, training_hours: e.target.value})} />
                </div>
                <div className="form-group">
                    <label>Notes</label>
                                ...
                                <tr key={r.report_id}>
                                    ...
                                    <td>
                                        {isEditing ? (
                                            ...
                                            <span style={{ color: r.attendance === 'Present' ? 'var(--accent-success)' : 'var(--accent-danger)', fontWeight: 700 }}>{r.attendance}</span>
                                        )}
                                    </td>
                                    <td>
                                        {isEditing ? (
                                    ...
                                    <td>
                                        {isEditing ? (
                                            <input type="number" className="glass-input" value={editForm.training_hours} onChange={e => setEditForm({...editForm, training_hours: e.target.value})} style={{ width: '60px', padding: '6px' }} />
                                        ) : (
...
export const PendingPlayersReview = () => {
    ...
    return (
        <div className="view-container fade-in">
            ...
            <div className="glass-table-container">
                <table className="glass-table">
                    <thead><tr><th>Name</th><th>Age</th><th>Gender</th><th>Assign Captain</th><th>Actions</th></tr></thead>
                    <tbody>
                        {players.length === 0 ? (
